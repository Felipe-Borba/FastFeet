/*
  ...
  - Added the required column `receiverId` to the `Parcel` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_Parcel" ("cep", "codigorastreio", "id", "responsibleId", "status", "tipoEntrega") SELECT "cep", "codigorastreio", "id", "responsibleId", "status", "tipoEntrega" FROM "Parcel";
DROP TABLE "Parcel";
